          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <div class="row">
                ...
                <div class="col-md-2">
                  <a href="{{ route('category-create') }}" class="btn btn-info btn-sm text-white pull-right">Add Order</a>
                </div>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                @if ($order->status  != 2 )
                                    <a href="{{ route('category-edit',$order->id) }}" class="btn btn-info btn-sm text-white"><i class="fa fa-edit fa-fw"></i> Edit</a>
                                    @if ($order->status  != 3)
                                        <a href="{{ route('category-edit',$order->id) }}" class="btn btn-danger btn-sm text-white"><i class="fa fa-edit fa-fw"></i> Cancel</a>
                                    @endif
                                ...
                                @if ($order->status == 2)
                                    <a href="{{ route('category-edit',$order->id) }}" class="btn btn-success btn-sm text-white"><i class="fa fa-edit fa-fw"></i> Invoice</a>
                                @endif
