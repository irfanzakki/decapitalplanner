        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:csonline@decapital.com">csonline@decapital.com</a>
        ...
        <div class="container pb-5">
            <div class="row">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">{{$catalog[0]->category_name}}</h1>
                            <p class="h3 py-2">Rp. {{$catalog[0]->price}}</p>
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <button type="submit" class="btn btn-success btn-lg" name="submit" value="buy">Order Now</button>
                                    </div>
                                    <div class="col d-grid">
